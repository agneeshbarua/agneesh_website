---
title: "Teleost convergence paper published"
date: 2026-04-19T15:34:30-04:00
categories:
  - blog
tags:
  - Jekyll
  - update
---
The update is a bit late on the webite, but the teleost convergence paper was published earlier this year in [MBE][MBE].  

![image]({{ site.url }}{{ site.baseurl }}/assets/images/conv.png) 
...
Using targeted simulations, we further show that in specific evolutionary scenarios, adaptation via pleiotropic genes may not only be possible, but even favoured [(see that here)][see that here]. While our study is not the first to raise this possibility, it is the first to demonstrate the pattern at such a broad phylogenetic scale in an exceptionally diverse vertebrate lineage like teleost fishes. As comparative genomics has expanded, similar observations have become increasingly difficult to ignore. Indeed a recent study in jellyfishes found the *exact* same patterns as we did, across almost double the phylogenetic distance [(Berger et al 2026)][jelly]. We are therefore now at a point where the classic view that pleiotropic genes are generally off-limits to adaptation, needs refinement in light of accumulating evidence.
 
[MBE]:https://doi.org/10.1093/molbev/msag015
[see that here]: https://www.biorxiv.org/content/10.1101/2024.06.24.600426v2.abstract
[jelly]: https://www.biorxiv.org/content/10.64898/2026.04.23.718300v1